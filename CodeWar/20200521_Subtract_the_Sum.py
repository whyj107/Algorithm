...
# 3. If the new n is in the list below return the associated fruit,
...
def subtract_sum(number):
    fruit = {1:'kiwi', 2:'pear', 3:'kiwi', 4:'banana', 5:'melon', 6:'banana', 7:'melon', 8:'pineapple', 9:'apple', 10:'pineapple',
